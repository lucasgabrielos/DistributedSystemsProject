const HeaderComponent = {
  ...
  <div class="w-full shadow-md bg-white">
    <div class="flex flex-col items-center lg:flex-row lg:justify-between p-4 lg:p-6">
      <!-- Barra de Pesquisa -->
      <form class="w-full lg:w-1/2 flex items-center space-x-2 mb-4 lg:mb-0">
        <input
          v-model="Search"
          type="text" 
          id="pesqui" 
      ...
      <div class="flex justify-center space-x-8">
        ...
        <a href="#/login" class="flex flex-col items-center">
          <button class="flex flex-col items-center focus:outline-none">
            ...
            <span class="text-xs lg:text-sm mt-1">Login</span>
          </button>
        </a>
        ...
        <a href="#/pagcad" class="flex flex-col items-center">
          <button class="flex flex-col items-center focus:outline-none">
            ...
            <span class="text-xs lg:text-sm mt-1">Cadastro</span>
          </button>
        </a>
      </div>
    </div>

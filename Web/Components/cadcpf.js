        ...
        <form  class="space-y-6">
            ...
            <div>
                <input type="text" name="endereco" placeholder="Endereço" required
                    class="w-full px-4 py-3 bg-white/20 border border-green-300 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 placeholder-gray-300 mb-4 transition-all">
